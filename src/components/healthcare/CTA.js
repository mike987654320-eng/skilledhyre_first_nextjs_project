    ...
    <Section className="text-center">
      <div className="max-w-4xl mx-auto p-12 rounded-3xl bg-gradient-to-br from-rose-600/20 to-pink-700/20 border border-rose-500/30">
        <h2 className="text-3xl md:text-5xl font-bold mb-6">
          🚀 Build the Future of Healthcare Today
        </h2>
        <p className="text-xl text-gray-300 mb-10">
          Digital health requires engineering precision and regulatory
          confidence. Innovate securely. Design intelligently. Heal faster.
        </p>
