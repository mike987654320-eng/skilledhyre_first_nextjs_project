        ...
        <div className="md:flex items-center justify-between gap-12">
          <div className="flex-1">
            <h2 className="text-[36px] font-bold mb-6">
              🔐 Security & Compliance in HR Systems
            </h2>
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              HR platforms handle sensitive employee and candidate data.
              Maintaining security and compliance is essential.
            </p>
            ...
            <p className="text-gray-400 mt-8">
              This ensures secure management of employee and candidate
              information.
            </p>
          </div>
          <div className="mt-12 md:mt-0 flex-shrink-0 w-full md:w-1/3 p-8 rounded-2xl bg-gradient-to-br from-rose-500/20 to-pink-500/20 border border-rose-500/30 text-center">
            ...
            <p className="text-gray-400 text-sm">
              Engineered to protect sensitive hiring information and ensure
