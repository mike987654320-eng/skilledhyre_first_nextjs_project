...
export default function WhyProduct() {
  const points = [
    "Accelerate technical product development",
    "Ensure high performance and scalability",
    "Reduce technical debt and complexity",
    "Improve user retention and engagement",
    "Adapt faster to market and user demands",
    "Build secure and compliant platforms",
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Winning products are built on strong engineering foundations. We
              help businesses move from prototype to production with precision
              and reliability.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 border border-white/10 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-400">
                Where strategic design meets advanced technical execution.
              </p>
            </div>
          </div>
        </div>
