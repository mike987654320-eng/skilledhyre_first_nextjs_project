...
export default function BlogCard({ title, date, excerpt, image, slug }) {
  return (
    <div className="flex-shrink-0 w-[350px] group rounded-2xl bg-white/5 border border-white/10 overflow-hidden hover:border-indigo-500/30 transition-all duration-300">
