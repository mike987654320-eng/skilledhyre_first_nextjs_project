...
export default function WhyCloud() {
  const points = [
    ...
    "Enable seamless global scalability",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-[36px] font-bold mb-6">
              🚀 Why Cloud & DevOps Engineering Matters
            </h2>
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Modern engineering is about speed and stability. DevOps bridges
              the gap between development and operations, while Cloud provides
              the unlimited scale needed for digital success.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 border border-white/10 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-400">
                Infrastructure that evolves as fast as your software does.
              </p>
            </div>
          </div>
        </div>
