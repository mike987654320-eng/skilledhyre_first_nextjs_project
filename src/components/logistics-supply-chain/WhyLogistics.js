...
export default function WhyLogistics() {
  const points = [
    ...
    "Ensure high levels of data integrity and security",
    "Reduce operational downtime with real-time tracking",
    "Improve route optimization with AI-driven insights",
    "Enable seamless integration with global carrier APIs",
    "Scale logistics operations with cloud-native engineering",
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-[36px] font-bold mb-6">
              🚀 Why Intelligent Logistics Engineering Matters
            </h2>
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Logistics is transitioning from manual oversight to automated,
              intelligent ecosystems. We help supply chain leaders lead this
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 border border-white/10 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-400">
                Where logistical strategy meets advanced technical execution.
              </p>
            </div>
          </div>
        </div>
