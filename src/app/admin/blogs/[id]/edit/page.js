...
// import { saveBlogs, getBlogs } from "../../../utils";
...
export default function EditBlogPage() {
          ...
          if (found.sections && found.sections.length > 0) {
            setSections(
              found.sections.map((s) => ({
                ...
                initialHtml: s.html || s.content, // Handle potentially different keys
  ...
  const addSection = () => {
    // New section has empty initialHtml
    setSections((prev) => [
      ...prev,
