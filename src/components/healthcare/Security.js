...
export default function Security() {
  const points = [
    "Strict HIPAA & GDPR compliance adherence",
    ...
    "Compliant cloud-native deployment models",
  ];
        ...
        <div className="md:flex items-center justify-between gap-12">
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              We understand the critical nature of health data.{" "}
              {"Security isn't"}
              {" an add-on — it's the foundation of everything we build for "}
              healthcare.
            </p>
          ...
          <div className="mt-12 md:mt-0 flex-shrink-0 w-full md:w-1/3 p-8 rounded-2xl bg-gradient-to-br from-rose-500/20 to-pink-500/20 border border-rose-500/30 text-center">
            ...
            <p className="text-gray-400 text-sm">
              Engineered for absolute data integrity and regulatory confidence.
            </p>
          </div>
        </div>
      </div>
