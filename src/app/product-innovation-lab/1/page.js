        ...
        >
          {[
            ...
            >
              ...
              <p style={{ color: "#a1a1aa", lineHeight: "1.6" }}>{cap.desc}</p>
            </div>
          ))}
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "From concept to launch — everything happens under one coordinated team.",
              },
              {
                title: "Agile Execution",
                desc: "Weekly sprints, transparent communication, structured milestones.",
              },
              {
          ...
          {[
            {
              ...
              desc: "Identify users, goals, workflows, and market gaps.",
            },
            {
              phase: "UX/UI Design",
              desc: "Craft intuitive interfaces and interactive prototypes.",
            },
            {
              phase: "Engineering",
              desc: "Build scalable, high-performance digital products.",
            },
            {
              phase: "Testing & QA",
              desc: "Ensure functionality, usability, speed, and security.",
            },
            {
              phase: "Launch & Deploy",
              desc: "Deployment to cloud platforms with monitoring.",
            },
            {
              phase: "Continuous Improvement",
              desc: "Feature upgrades, optimization, and support.",
            },
          ].map((step, i) => (
            <div
              key={i}
